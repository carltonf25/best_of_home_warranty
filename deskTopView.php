<div class="row">
       ...
       <ul>
              ...
              <a itemprop="url" href="http://www.afchomeclub.com/home-warranty-free-quote-BOHW.php" target="_blank"><button class="quote hvr-grow" onclick="ga('send', 'event', 'visitSite', 'click', 'AFC');">Visit Site</button></a><br/>
              <a href="http://www.afchomeclub.com/home-warranty-free-quote-BOHW.php">(678)-236-0646</a>
              </div>   
        ...
        <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
            ...
            <a itemprop="url" href="http://chwplan.com/a/a54/index.php?utm_source=bohwfm&amp;utm_campaign=SUBID" target="_blank"><button class="quote hvr-grow" onclick="ga('send', 'event', 'visitSite', 'click', 'Choice');">Visit Site</button></a><br/>
            <a href="http://chwplan.com/a/a54/index.php?utm_source=bohwfm&amp;utm_campaign=SUBID">(800)-816-1053</a>
            </div> 
        ...
        <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
            ...
            <a itemprop="url" href="https://selecthomewarranty.com/affiliate/3c0c53" target="_blank"><button class="quote hvr-grow" onclick="ga('send', 'event', 'visitSite', 'click', 'Select');">Visit Site</button></a><br/>
            <a href="https://selecthomewarranty.com/affiliate/3c0c53">855-610-4663</a>
            </div>
...
<!--BEGIN SECOND ROW !-->
        <div class="row">
            ...
            <a itemprop="url" href="/secure/secure.html" target='_blank'><button class="quote hvr-grow">Visit Site</button></a>
            </div>
