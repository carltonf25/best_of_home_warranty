...
<html lang="en">
<head>
<title>Best Home Warranty Comparison 2016</title>
<meta name="description" content="Home warranty companies in a side-by-side detailed review.  Get informed of the facts before you shop.">
<meta name="keywords" content="Home, Home Warranty, home, pricing, home warranty plans, home warranty policies, business, reviews, nationwide home warranty, comparison, 2016, best, leading, top home warranty, repair, claim">
...
<!--BEGIN FIRST ROW!-->
       ...
       <ul>
                ...
                <li><strong>Pricing locked in? Yes</strong></li>
                <li><strong>Length of policies:</strong> 1 / 3 years</li>
        ...
        <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
              <button src="javascript:void(0)" class="ribbon" id="choicebutton" onclick = "displayPromo(this.id); ga('send', 'event', 'promoRibbon', 'promoClick', 'Choice');">Click to view Promotions</button><span class="endtop"></span><span class="endbottom"></span>
            <div class="company-logo choice">
                <img itemprop="logo" id="choice" src="http://res.cloudinary.com/goodsearch/image/upload/v1449103404/hi_resolution_merchant_logos/choice-home-warranty_coupons.png" alt="Choice Home Warranty Logo">
            </div>
            <ul>
                <li><strong>Waiting Period:</strong> 30 days</li>
                <li><strong>Service Fee: </strong> $60</li>
        ...
        <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
              <button src="javascript:void(0)" class="ribbon" id="selectbutton" onclick = "displayPromo(this.id); ga('send', 'event', 'promoRibbon', 'promoClick', 'Select');">Click to view Promotions</button><span class="endtop"></span><span class="endbottom"></span>
            <div class="company-logo select">
                <img itemprop="logo" id="select" src="https://selecthomewarranty.com/assets/logo.png" alt="Select Home Warranty Logo">
            </div>
            <ul>
                <li><strong>Waiting Period:</strong>15 - 30 days</li>
                <li><strong>Service Fee:</strong>$60</li>
                <li><strong>Work Guarantee:</strong> 90 days parts/labor</li>
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong>Yes</li>
            ...
            <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
              <button src="javascript:void(0)" class="ribbon" id="totalbutton" onclick = "displayPromo(this.id); ga('send', 'event', 'promoRibbon', 'promoClick', 'Total');">Click to View Promotions</button>
              <span class="endtop"></span><span class="endbottom"></span>
                <div class="company-logo totalprotect">
                <img itemprop="logo" id="totalprotect" src="https://media.consumeraffairs.com/files/cache/guide-campaign-logos/total_protect_logo_thumbnail.jpg" alt="Total Protect Logo">
                </div>
            <ul>
                <li><strong>Waiting Period:</strong> 15 days</li>
                <li><strong>Service Fee:</strong> $75, $100, $125</li>
                <li><strong>Work Guarantee:</strong> 6 months parts/labor</li>
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong> No</li>
...
<!--BEGIN SECOND ROW !-->
        <div class="row">
            ...
            <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
            <div class="company-logo secure">
                <img itemprop="logo" id="secure" src="http://securehomewarranty.com/images/brand/SecureHomeWarranty_Logo_V2_400w_trimmed.jpg" alt="Secure Home Warranty Logo">
            </div>
            <ul>
                <li><strong>Waiting Period:</strong>30 days</li>
                <li><strong>Service Fee:</strong> $65</li>
                <li><strong>Work Guarantee:</strong> 90 days<br><br></li>
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong> No</li>
                <li><strong>Average response time:</strong> 24-48 hours</li>
            ...
            <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
                <div class="company-logo">
                <img itemprop="logo" id="firstam" src="https://media.consumeraffairs.com/files/logos/first-american-home-buyers-protection_logo_2521.png" alt="First American Logo">
                </div>
            <ul>
                <li><strong>Waiting Period:</strong> 30 days</li>
                <li><strong>Service Fee:</strong> $65</li>
                <li><strong>Work Guarantee:</strong> 30 days parts/labor</li> 
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong> No</li>
                <li><strong>Average response time:</strong> 24-48 hours</li>
                <li><strong>Pricing locked in?</strong> No</li>
        ...
        <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
            <div class="company-logo">
                <img itemprop="logo" id="delta" src="http://www.deltahomeprotect.com/wp-content/uploads/2015/06/delta-home-protect-retina.png" alt="Delta Home Protect Logo">
            </div>
            <ul>
                <li><strong>Waiting Period:</strong> 30 days</li>
                <li><strong>Service Fee:</strong> $45</li>
                <li><strong>Work Guarantee:</strong> 90 days parts/labor</li>
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong> No</li>
                <li><strong>Average response time:</strong> 24-48 hours</li>
            ...
            <div itemscope itemtype="http://schema.org/Organization" class="colrow col-md-3">
                <div class="company-logo">
                <img itemprop="logo" src="http://jlspartnerconnection.com/wp-content/uploads/sites/4/2014/07/AHS-Logo-new.jpg" alt="American Home Shield Logo">
                </div>
            <ul>
                <li><strong>Waiting Period:</strong> 15 days</li>
                <li><strong>Service Fee:</strong> $75, $100, $125</li>
                <li><strong>Work Guarantee:</strong> Depends on technician</li>
                <li><strong>Availability:</strong> Nationwide</li>
                 <li><strong>Can choose your own service tech?</strong> No</li>
                <li><strong>Average response time:</strong> 24-48 hours</li>
                <li><strong>Pricing locked in?</strong> No</li>
   ...
   <!--Mobile Columns!-->     
         <div class="row">
          <div itemscope itemtype="http://schema.org/Organization" target="contact" class="colrow col-xs-6">
              <span class="ribbon mobile">Best Customer Service</span><span class="endtop"></span><span class="endbottom"></span>
            <div class="company-logo">
              <img itemprop="logo" src="http://home-warranty-company-reviews.com/wp-content/uploads/2015/01/AFC-Home-Club-Logo_Stacked-360x203.jpg" alt="AFC Logo">
              </div>
       <ul>
          ...
          <div itemscope itemtype="http://schema.org/Organization" target="contact" class="colrow col-xs-6">
            ...
            <ul>
                ...
                <li><strong>Years in Business:</strong> 8</li>
                <li><strong>Cancellation Fee:</strong> $50</li>
                <li class="reviewholder"><a href="https://www.consumeraffairs.com/homeowners/choice_home_warranty.html" target="_blank"><img class="consumeraffair" src="https://media.consumeraffairs.com/static/img/common/trusted-shield-102.036a65cca665.png" alt="Consumer Affairs"><br><h4>Consumer Affairs Accredited<br>Click for Review</h4></a></li>
              </ul> 
        ...
        <div class="row">
          <div itemscope itemtype="http://schema.org/Organization" target="contact" class="colrow col-xs-6">
            ...
            <ul>
                ...
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong> No</li>
                <li><strong>Average response time:</strong> 24-48 hours<br><br></li>
                <li><strong>Pricing locked in?</strong> No</li>
                <li><strong>Length of policies:</strong> 1 / 3 / 5 years</li>
                <li><strong>Monthly options:</strong> 1 year plan only</li>
                <li><strong>Years in Business:</strong> 4</li>
                <li><strong>Cancellation Fee:</strong> $75</li>
                <li class="reviewholder"><a href="https://www.consumeraffairs.com/homeowners/delta-home-protect.html" target="_blank"><img class="consumeraffair" src="https://media.consumeraffairs.com/static/img/common/trusted-shield-102.036a65cca665.png" alt="Consumer Affairs Logo"><br><h4>Consumer Affairs Accredited<br>Click for Review</h4></a></li>
              </ul> 
...
<!--BEGIN SECOND ROW !-->
        <div class="row">
          ...
          <div itemscope itemtype="http://schema.org/Organization" target="contact" class="colrow col-xs-6">
            <div class="company-logo secure">
                <img itemprop="logo" src="http://securehomewarranty.com/images/brand/SecureHomeWarranty_Logo_V2_400w_trimmed.jpg" alt="Secure Home Warranty Logo" id ="secure-mobile-logo">
            </div>
            <ul>
                <li><strong>Waiting Period:</strong> 30 days</li>
                <li><strong>Service Fee:</strong> $65</li>
                <li><strong>Work Guarantee:</strong> 90 days </li>
                <li><strong>Availability:</strong> Nationwide</li>
                <li><strong>Can choose your own service tech?</strong> No</li>
                <li><strong>Average response time:</strong> 24-48 hours</li>
                <li><strong>Pricing locked in?</strong> Yes</li>
                ...
                <li><strong>Cancellation Fee:</strong> $0</li>
                <li class="reviewholder"><a href="http://securehomewarranty.com/" target="_blank"> <img class="consumeraffair" src="https://media.consumeraffairs.com/static/img/common/trusted-shield-102.036a65cca665.png" alt="Consumer Affairs Logo"><br><h4>Consumer Affairs Accredited<br></h4></a></li>
              </ul> 
            <a itemprop="url" href="http://securehomewarranty.com/" target='_blank'><button class="quote hvr-grow">Visit Site</button></a>
            </div>  
          ...
          <div itemscope itemtype="http://schema.org/Organization" target="contact" class="colrow col-xs-6">
                <div class="company-logo">
                <img itemprop="logo" src="https://media.consumeraffairs.com/files/logos/first-american-home-buyers-protection_logo_2521.png" alt="First American Logo" id="fa-mobile-logo">
                </div>
            <ul>
                <li><strong>Waiting Period:</strong> 30 days</li>
                <li><strong>Service Fee:</strong> $65</li>
                ...
                <li><strong>Average response time:</strong> 24-48 hours</li>
                <li><strong>Pricing locked in?</strong> No</li>
                <li><strong>Length of policies:</strong> 1 year plans only</li>
                <li><strong>Monthly options:</strong> 1 year plans only</li>
                <li><strong>Years in business:</strong> 32</li>
                <li><strong>Cancellation Fee:</strong> $50</li>
                <li class="reviewholder"><a href="http://www.bbb.org/losangelessiliconvalley/business-reviews/home-warranty-plans/first-american-home-buyers-protection-corporation-in-canoga-park-ca-18779" target="_blank"><img class="bbb" src="http://theoverheaddoordepot.com/wp-content/uploads/BBB-Logo-Blue-Horizontal.png?quality=100.3015112611140" alt="BBB Logo"><br><h4>B BBB Rating<br>Click for Review</h4></a>
                </li>
              </ul>   
          ...
          <div itemscope itemtype="http://schema.org/Organization" target="contact" class="colrow col-xs-6" id="ahs-mobile-col">
                <div class="company-logo americanhomeshield">
                <img itemprop="logo" src="http://jlspartnerconnection.com/wp-content/uploads/sites/4/2014/07/AHS-Logo-new.jpg" alt="American Home Shield Logo" id="ahs-mobile-logo">
                </div>
            <ul>
                <li><strong>Waiting Period:</strong> 15 days</li>
                <li><strong>Service Fee:</strong> $75/100/125</li>
...
<!--Start of bottom content!-->
  <div class="container">
        <h1><strong>Home Warranty Basics:</strong></h1>
        <p>Home warranties are extremely popular among every type of homeowner.</p>
        <p>In essence, nearly every home warranty company out there is a type of service contract.  By paying an annual or monthly fee, the home warranty company will dispatch one of their pre-vetted technicians to perform repairs in the home.  By having a home warranty, homeowners can save upwards of $5000 in repairs.  Often a home warranty is also included with the sale of the home which can protect the buyer from unexpected and costly repairs.  Home warranties aren't always beneficial; if you are pretty handy yourself and can fix or troubleshoot minor issues then perhaps a home warranty isn't for you.</p>
        <p>As with any business, home warranty companies will have inclusions and exclusions.  A good rule of thumb for home warranty coverage is if it's inside the home, it is covered.  There are exceptions to this however; many home warranty companies do not cover pre-existing conditions, improperly sized units or insufficiently maintained units.  Some home warranty companies are more strict in their exclusions than others and some have higher caps on the amount paid per year.  With so many options to choose from, it is difficult to compare them efficiently.</p>
        <p>Thats why we made this site.  To collect and present all the information that as a consumer, you should know.  We were once home warranty shoppers ourselves and were bewildered by the amount of pushy salesmen who provided little to no detail about how home warranty companies operate.  We hope you find this site useful and informative as you look for a home warranty provider.</p>
    </div>
<!--PROMOTIONAL POPUPS!-->
...
<div id="afcpromo" class="company_discounts">
    ...
    <a href="http://www.afchomeclub.com/home-warranty-free-quote-BOHW.php" target="_blank"><button class="promo quote hvr-grow" onclick="ga('send','event', 'promoSite', 'promoVisit','AFC');">Visit Site</button></a>
</div>
<!--END AFC POPUP!-->
<div id="fade" class="black_overlay"></div>
<!--CHOICE PROMO POPUP!-->
<div id="choicepromo" class="company_discounts">
    <a id="x" class="hvr-fade" href="javascript:void(0)" onclick = "closePromo();">&#9747;</a>
    <div class="promo_logo_holder">
    <img class="promo_logo" src="http://res.cloudinary.com/goodsearch/image/upload/v1449103404/hi_resolution_merchant_logos/choice-home-warranty_coupons.png" alt="Choice Home Warranty logo" />
    </div>
    <ul class="promolist">
...
<!--SELECT PROMO POPUP!-->
<div id="selectpromo" class="company_discounts">
    <a id="x" class="hvr-fade" href="javascript:void(0)" onclick = "closePromo();">&#9747;</a>
    <div class="promo_logo_holder">
...
<div id="totalpromo" class="company_discounts">
    <a id="x" class="hvr-fade" href="javascript:void(0)" onclick = "closePromo();">&#9747;</a>
    <div class="promo_logo_holder">
    <img class="promo_logo" src="https://media.consumeraffairs.com/files/cache/guide-campaign-logos/total_protect_logo_thumbnail.jpg" alt="Consumer Affairs logo">
    </div>
    <ul class="promolist">
        <li>$100 off Combo Plans for limited time</li>
        <li>Most comprehensive Combo Plan in the industry at the moment.</li>
    </ul>
    <p>*Some promotions may require a quote request</p>
